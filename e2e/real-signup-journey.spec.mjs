...
const traderEmail = `buildpair-trader+clerk_test_${runId}@example.com`;
const customerEmail = `buildpair-homeowner+clerk_test_${runId}@example.com`;
...
async function createInvoice(page) {
  ...
  // Exercise the real email action. Test addresses may be rejected by the provider; the invoice must still be saved safely.

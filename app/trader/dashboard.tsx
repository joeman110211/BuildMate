...
export default function TraderDashboard() {
  ...
  return <Screen title={`Hello, ${profile.businessName}`} subtitle={`${profile.tradeCategory} · ${profile.subscriptionTier} plan`}>
    ...
    {!jobs.length ? <EmptyState title="No jobs available" body={profile.subscriptionTier === 'basic' ? 'Direct customer requests will appear here.' : `New ${profile.tradeCategory.toLowerCase()} jobs will appear here.`} /> : jobs.map((job) => {

...
const styles = StyleSheet.create({ row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }, muted: { color: colors.muted }, stars: { flexDirection: 'row', gap: 6, flexWrap: 'wrap' }, gallery: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, photo: { width: 180, height: 135, borderRadius: 10, backgroundColor: colors.border }, cancelBox: { borderTopWidth: 1, borderColor: colors.border, paddingTop: 10, gap: 8 } });

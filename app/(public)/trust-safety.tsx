...
export default function TrustSafetyPage() {
  return <PublicInfoPage
    ...
    intro="BuildPair is designed to show useful context about tradespeople and completed work while keeping marketplace safety, privacy and moderation visible rather than hiding them behind a generic trust badge."
    sections={[
      ...
      { title: 'Human moderation and account controls', body: <View style={infoStyles.list}><Text style={infoStyles.item}>• Users can report spam, fraud, abuse and other marketplace concerns.</Text><Text style={infoStyles.item}>• Authorised moderators can review context rather than relying on one isolated word or automated flag.</Text><Text style={infoStyles.item}>• BuildPair can warn, restrict, close or reopen conversations and suspend or restore accounts where appropriate.</Text><Text style={infoStyles.item}>• Serious legal or immediate safety concerns should still be reported to the appropriate emergency service, regulator or authority.</Text></View> },

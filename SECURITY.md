...
BuildMate’s client is untrusted. Authorization, monetary totals, quote acceptance, review eligibility, subscription state and payment state are enforced by the API/database or verified provider webhooks.
